...
define([
	...
	'lang',
	'array'
], function (compose, listen, promise, lang, array) {
	'use strict';
	return compose(
		compose,
		listen.Evented,
				...
				return this._getModule().then(function (module) {
					...
					if (lang.isFunction(module)) {
						...
						return promise.allKeys(deps).then(function (deps) {
							var inst, proto = {};
							// XXX: ugly workaround for dojo.declare :(
							if (module.extend && module.prototype.isInstanceOf) {
								// copy the prototype
								compose.call(proto, module.prototype);
								// create an instance
								inst = compose.create(
									module.extend(deps).extend(model.mixin).extend(args)
								);
								// put the prototype back as it was
